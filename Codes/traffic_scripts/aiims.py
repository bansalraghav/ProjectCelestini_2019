...
def scrape_gmaps_data(frequency, duration):
    ...
    request_url = "https://api.tomtom.com/traffic/services/4/flowSegmentData/absolute/10/json?key=HiA2ysxthwHpirgLzFrUJQOQDkhR3a1x&point=28.5671774,77.2078516"

    with open("aiims_trafficData.csv", 'a') as file:

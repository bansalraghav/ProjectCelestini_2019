...
def scrape_gmaps_data(frequency, duration):
    ...
    request_url = "https://api.tomtom.com/traffic/services/4/flowSegmentData/absolute/10/json?key=HiA2ysxthwHpirgLzFrUJQOQDkhR3a1x&point=28.707711,77.1774568"

    with open("azadpur_trafficData.csv", 'a') as file:

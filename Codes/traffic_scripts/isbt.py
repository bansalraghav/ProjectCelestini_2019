...
def scrape_gmaps_data(frequency, duration):
    ...
    request_url = "https://api.tomtom.com/traffic/services/4/flowSegmentData/absolute/10/json?key=HiA2ysxthwHpirgLzFrUJQOQDkhR3a1x&point=28.676097,77.227844"

    with open("isbt_trafficData.csv", 'a') as file:
